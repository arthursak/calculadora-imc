...
while valid_peso == False:
    peso = input('Dogite o peso (Ex. 68.5): ')
    try:
        peso = float(peso)
        ...
        ('Peso inválido. Use apenas números e separe os decimais com ponto.')

valid_altura = False
while valid_altura == False:
    altura = input('Dogite a sua altura em metros (Ex. 1.70): ')
    try:
        altura = float(altura)
        ...
        ('Altura inválida. Use apenas números e separe os decimais com ponto.')
